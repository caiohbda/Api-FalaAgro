...
var newsRoutes_exports = {};
__export(newsRoutes_exports, {
  noticiasRoutes: () => noticiasRoutes
});
module.exports = __toCommonJS(newsRoutes_exports);
...
// src/routes/newsRoutes.ts
var noticiasRoutes = (fastify) => __async(void 0, null, function* () {
